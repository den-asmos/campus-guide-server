...
> {
	...
	declare faculty: CreationOptional<Faculty | null>;
	declare course: CreationOptional<number | null>;
	declare group: CreationOptional<Group | null>;
	...
	public toSafeObject(): Omit<InferAttributes<User>, "password"> {
